  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled
          ? 'bg-dark-teal/90 backdrop-blur-md shadow-xl border-b border-white/10 py-3'
          : 'bg-transparent py-5'
        }`}
    >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-dark-teal/95 backdrop-blur-xl border-t border-white/10 shadow-2xl overflow-hidden"
          >
